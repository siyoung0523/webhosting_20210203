...
namespace CustCar0415.Utill
{
    class MyMenu
    {
        ...
        public const int MENU_SUB_IntData_CAR = 1;
        public const int MENU_SUB_IntData_CUST = 2;
        public const int MENU_SUB_IntData_SELL = 3;
        public const int MENU_SUB_IntData_EXIT = 4;

        public const int MENU_SUB_AllDel_CAR = 1;
        public const int MENU_SUB_AllDel_CUST = 2;
        public const int MENU_SUB_AllDel_SELL = 3;
        public const int MENU_SUB_AllDel_EXIT = 4;
        ...
        {
            //try catch를 통해 사용자가 다른 걸 입력했을 때 메세지를 띄움.
            int menu = 0;
            try
            {
                Console.WriteLine("----------------");
        ...
        public int subUpdateMenu()
        {
            ...
            Console.WriteLine("데이터 추가 선택");
            Console.WriteLine("----------------");
            Console.WriteLine("1. 차량 정보 업데이트 :");
            Console.WriteLine("2. 고객 정보 업데이트 :");
            Console.WriteLine("3. 판매자 정보 업데이트");
            Console.WriteLine("4. 종료");
            Console.WriteLine("----------------");
            Console.WriteLine("메뉴 선택 :");
        ...
        public int subInsDataMenu()
        {
            Console.WriteLine("----------------");
            Console.WriteLine("데이터 추가 선택");
            Console.WriteLine("----------------");
            Console.WriteLine("1. 차량 정보 랜덤 데이터 생성 :");
            Console.WriteLine("2. 고객 정보 랜덤 데이터 생성 :");
            Console.WriteLine("3. 판매자 정보 랜덤 데이터 생성 :");
            Console.WriteLine("4. 종료");
            Console.WriteLine("----------------");
            Console.WriteLine("메뉴 선택 :");
        ...
        public int subAllDelMenu()
        {
            Console.WriteLine("----------------");
            Console.WriteLine("데이터 추가 선택");
            Console.WriteLine("----------------");
            Console.WriteLine("1. 차량 정보 데이터 전체삭제 :");
            Console.WriteLine("2. 고객 정보 데이터 전체삭제 :");
            Console.WriteLine("3. 판매자 정보 데이터 전체삭제 :");
            Console.WriteLine("4. 종료");
            Console.WriteLine("----------------");
            Console.WriteLine("메뉴 선택 :");
        ...
        public int subViewMenu()
        {
            ...
            Console.WriteLine("데이터 추가 선택");
            Console.WriteLine("----------------");
            Console.WriteLine("1. 차량 정보 보기 :");
            Console.WriteLine("2. 고객 정보 보기 :");
            Console.WriteLine("3. 판매자 정보 보기 :");
            Console.WriteLine("4. 종료");
            Console.WriteLine("----------------");
            Console.WriteLine("메뉴 선택 :");
